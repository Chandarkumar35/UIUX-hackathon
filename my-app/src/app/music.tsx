...
export default function Music() {
    return (
        ...
        <div className='sm:w-full md:w-[70%] sm:p-5 md:p-5 sm:h-auto md:h-[500px] flex sm:flex-col md:flex-row sm:justify-start md:justify-center sm:items-start md:items-center bg-black'>
            <div className='sm:w-full md:w-[50%] p-4'>
                ...
                <button className='bg-green-500 hover:bg-green-800 sm:hidden md:block sm:px-3 md:px-7 sm:text-sm py-0 text-white font-bold rounded-sm h-10 mt-3'>
                    ...
                    <div className='sm:w-full md:w-[40%] lg:w-[40%] justify-center items-center'>
                    <img src="../music.png" alt="music speaker" className='max-w-full h-auto'/>
                    </div>
